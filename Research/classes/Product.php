...
/**************************************************
*       TOP BRAND PRODUCT FUNCTION
***************************************************/

    public function firstLabelName(){
        $query ="SELECT * FROM tbl_brand WHERE brandId = '1'";
        $result = $this->db->select($query);
        return $result;
    }  

    public function secondLabelName(){
        $query ="SELECT * FROM tbl_brand WHERE brandId = '2'";
        $result = $this->db->select($query);
        return $result;
    } 

    public function thirdLabelName(){
        $query ="SELECT * FROM tbl_brand WHERE brandId = '3'";
        $result = $this->db->select($query);
        return $result;
    }


    public function firstLabelProduct(){
        $query ="SELECT * FROM tbl_product WHERE brandId = '1' ORDER BY productId DESC LIMIT 4";
        $result = $this->db->select($query);
        return $result;
    }

    public function secondLabelProduct(){
          $query ="SELECT * FROM tbl_product WHERE brandId = '2' ORDER BY productId DESC LIMIT 4";
          $result = $this->db->select($query);
          return $result;
    }
    public function thirdLabelProduct(){
